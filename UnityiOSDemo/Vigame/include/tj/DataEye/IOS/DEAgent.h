...
#import "tj/DataEye/DCAccountType.h"
#import "tj/DataEye/DCGender.h"
#import "tj/DataEye/DCTaskType.h"
#import "tj/DataEye/DCReportMode.h"
 ...
 */
+(void)play:(NSString*)roomId roomType:(NSString*)roomType coinType:(NSString*)coinType lostOrGainCoin:(long long)coinNum taxCoin:(long long)tax leftCoin:(long long)left;
 ...
 */
+(void)lost:(NSString*)roomId roomType:(NSString*)roomType coinType:(NSString*)coinType lostCoin:(long long)lost leftCoin:(long long)left;
 ...
 *  @param leftCoin  剩余的虚拟币数量
 */
+(void)gain:(NSString*)roomId roomType:(NSString*)roomType coinType:(NSString*)coinType gainCoin:(long long)gain leftCoin:(long long)left;
