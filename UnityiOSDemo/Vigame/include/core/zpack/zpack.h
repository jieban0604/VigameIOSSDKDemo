...
///////////////////////////////////////////////////////////////////////////////////////////////////
std::shared_ptr<IPackage> create(const Char* filename, u32 chunkSize = 0x40000, u32 fileUserDataSize = 0);
std::shared_ptr<IPackage> open(const Char* filename, u32 flag = OPEN_READONLY | OPEN_NO_FILENAME);
std::shared_ptr<IPackage> open(FILE* file, u32 flag = OPEN_READONLY | OPEN_NO_FILENAME);
