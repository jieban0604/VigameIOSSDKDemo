...
class MSDKLoginAuthResult : public SocialResult
{
public:
...
class MSDKLoginAccessTokenResult : public SocialResult
{
public:
	...
	MSDKLoginAccessTokenResult();
	virtual bool parse(const std::unordered_map<std::string, std::string>& param) override;
};

class MSDKLoginResult : public SocialLoginResult
{
public:
	MSDKLoginAuthResult loginAuthResult;
	MSDKLoginAccessTokenResult loginAccessTokenResult;
