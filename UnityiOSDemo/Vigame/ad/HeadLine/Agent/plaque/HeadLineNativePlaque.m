...
@interface HeadLineNativePlaque () <BUNativeAdDelegate>
...
-(void)vigame_openHeadLineNativePlaque {
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        }
        {
            ...
            UIView *bgView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, realSize.width, 115+realSize.width*2/3.0)];
            bgView.userInteractionEnabled = NO;
            bgView.center = self.plaqueView.center;
            [self.plaqueView insertSubview:bgView atIndex:0];
            ...
            coverBtn.frame = CGRectMake(0, 0, realSize.width, 115+realSize.width*2/3.0);
            [containView addSubview:coverBtn];
            
            [coverBtn addTarget:self action:@selector(headline_nativeAdClicked) forControlEvents:UIControlEventTouchUpInside];
            ...
            [self.nativeAd registerContainer:self.plaqueView withClickableViews:@[coverBtn]];
        }
    });
}
