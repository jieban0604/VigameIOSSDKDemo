...
-(void)loadWithParam:(NSDictionary *)param callback:(void (^)(NSDictionary *))cb{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        self.interstitialAd = [[BUInterstitialAd alloc] initWithSlotID:param[KTMLoadPlaceCodeId] size:[BUSize sizeBy:BUProposalSize_Interstitial600_600]];
...
-(void)vigame_openHeadLinePlaque{
    if (self.interstitialAd && self.interstitialAd.adValid) {
