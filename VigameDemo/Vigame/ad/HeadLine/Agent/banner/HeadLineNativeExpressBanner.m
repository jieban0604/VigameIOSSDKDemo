...
-(void)vigame_openHeadLineNativeExpressBanner {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        self.bannerView = [[BUNativeExpressBannerView alloc] initWithSlotID:self.adParam[KTMLoadPlaceCodeId] rootViewController:rootViewController imgSize:imgSize adSize:CGSizeMake(screenWidth, bannerHeigh) IsSupportDeepLink:YES];
...
- (void)nativeExpressBannerAdViewDidLoad:(BUNativeExpressBannerView *)bannerAdView {
    ...
    UIViewController *rootViewController = [VBAdUtils getBannerViewController];
    [rootViewController.view insertSubview:self.bannerView atIndex:0];
}
